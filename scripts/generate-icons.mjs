/**
 * public/pwa/icon.svg 에서 PWA용 PNG 아이콘을 만든다.
 *
...
for (const size of [192, 512]) {
  await sharp(svg, { density: 400 }).resize(size, size).png().toFile(`public/pwa/icon-${size}.png`);
}

// iOS 홈화면 아이콘
await sharp(svg, { density: 400 }).resize(180, 180).png().toFile('public/pwa/icon-180.png');
